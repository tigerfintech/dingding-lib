...
var Markdown = function (_Basic) {
    _inherits(Markdown, _Basic);

    function Markdown(options) {
        _classCallCheck(this, Markdown);

        var _this = _possibleConstructorReturn(this, (Markdown.__proto__ || Object.getPrototypeOf(Markdown)).call(this, options));
